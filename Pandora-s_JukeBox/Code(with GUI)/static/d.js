...
dislikeBtn5.addEventListener ("click", function() {
   ...
   likeBtn5.disabled = true;
	...
	status_flag.concat(sf1);		
	status_flag.concat(" ");
	status_flag.concat(sf2);		
	status_flag.concat(" ");
	status_flag.concat(sf3);		
	status_flag.concat(" ");
	status_flag.concat(sf4);		
	status_flag.concat(" ");
	status_flag.concat(sf5);		
	status_flag.concat(" ");
	status_flag.concat(sf6);
	$.get( "/getmethod/<status_flag>");
}
